...
function getParameterFromQueryString(query, qParam) {
...
exports.setPaginationParams = function (params) {
    if (params.next_results) {
        console.log("scbsbcdcbsdk")
        // Find max_id and attach to params
        let max_id = getParameterFromQueryString(params.next_results, 'max_id');
        ...
        let since_id = getParameterFromQueryString(params.refresh_url, 'since_id');
